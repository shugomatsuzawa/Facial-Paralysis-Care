...
const Diagnose10Screen = ({ route, navigation }) => {
  ...
  const addParams = (score) => {
    ...
    setIsCameraOpen(false);
    params.henoji = score;
    navigation.navigate('DiagnoseResult', params)
  }
    ...
    <View style={[styles.container, {backgroundColor: theme.colors.dynamic.background}]}>
      <View style={styles.cameraContainer}>
        {isCameraOpen && !hasPermission ? (
          ...
          <Image source={require('../../assets/images/10_henoji.png')} style={styles.exampleImage} />
        )}
      ...
      <SafeAreaView style={styles.inputContainer}>
        <View>
          <View style={styles.progress}>
            <Text variant="displayLarge" style={{color: theme.colors.dynamic.primary}}>10</Text>
...
export default Diagnose10Screen;
