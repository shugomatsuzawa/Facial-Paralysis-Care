...
const Diagnose05Screen = ({ route, navigation }) => {
  ...
  const addParams = (score) => {
    ...
    setIsCameraOpen(false);
    params.katame = score;
    navigation.navigate('Diagnose06', params)
  }
    ...
    <View style={[styles.container, {backgroundColor: theme.colors.dynamic.background}]}>
      <View style={styles.cameraContainer}>
        {isCameraOpen && !hasPermission ? (
          ...
          <Image source={require('../../assets/images/05_katame.png')} style={styles.exampleImage} />
        )}
      ...
      <SafeAreaView style={styles.inputContainer}>
        <View>
          <View style={styles.progress}>
            <Text variant="displayLarge" style={{color: theme.colors.dynamic.primary}}>05</Text>
...
export default Diagnose05Screen;