...
const Training02Screen = ({ navigation }) => {
  ...
  const addParams = () => {
    setIsCameraOpen(false);
    navigation.navigate('Training03')
  }
      ...
      <SafeAreaView style={styles.inputContainer}>
        <View>
          <View style={styles.progress}>
            <Text variant="displayLarge" style={{color: theme.colors.dynamic.primary}}>02</Text>
...
export default Training02Screen;